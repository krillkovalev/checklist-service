...
func ToRedisSet(ctx context.Context, rdb *redis.Client, key string, task *models.Task) error {
...
func DeleteFromCache(ctx context.Context, rdb *redis.Client, id int64) error {
...
func UpdateCache(db *sql.DB, rdb *redis.Client) ([]models.Task, error){
